...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand" style="margin-left: -20px" href=" https://smkn1-sby.sch.id/ " target="_blank">
      ...
      <span class="ms-0 font-weight-bold" style="font-size: 10.5px">Management Ruang Sekolah</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link @if(Request::is('adminrequest')) active @endif" href="/adminrequest">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link @if(Request::is('adminedit','editpengguna','editruangan','editpengguna/create')) active @endif" href="/adminedit">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
