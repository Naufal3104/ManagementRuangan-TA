                    ...
                    <div class = "card-body">
                      ...
                      @endif
                        <form class="row g-3" method = "POST" enctype  = "multipart/form-data" action="{{route('editruangan.store')}}">
                          @csrf 
                            <h4 class="text-center">Pilih salah satu</h4>
                            <div class="col-md-6">
                              <label for="id_user" class="form-label">Token User</label>
                              <input type="text" class="form-control" autocomplete="off" id="Namaruangan" name="Namaruangan" value="{{old('Namaruangan')}}">
                            </div>
                            <div class="col-md-6">
                              <label for="id_guest" class="form-label">Token Guest</label>
                              <input type="text" class="form-control" autocomplete="off" id="Namaruangan" name="Namaruangan" value="{{old('Namaruangan')}}">
                            </div>
                            <div class = "col-md-12">       
